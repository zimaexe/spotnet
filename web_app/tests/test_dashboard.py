...
async def test_get_dashboard_success():
    ...
    with patch('web_app.api.dashboard.position_db_connector.get_contract_address_by_wallet_id') as mock_get_contract_address_by_wallet_id, \
         patch('web_app.api.dashboard.position_db_connector.get_positions_by_wallet_id') as mock_get_positions_by_wallet_id, \
         patch('web_app.contract_tools.mixins.dashboard.DashboardMixin.get_wallet_balances', new_callable=AsyncMock) as mock_get_wallet_balances, \
         patch('web_app.contract_tools.mixins.dashboard.DashboardMixin.get_zklend_position', new_callable=AsyncMock) as mock_get_zklend_position:
...
async def test_get_dashboard_invalid_wallet_id():
    ...
    with patch('web_app.api.dashboard.position_db_connector.get_contract_address_by_wallet_id') as mock_get_contract_address_by_wallet_id:
        ...
        mock_get_contract_address_by_wallet_id.side_effect = Exception("Invalid wallet ID")
