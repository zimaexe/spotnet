...
class TestDashboardMixin:
    ...
    async def test_get_zklend_position_success(
        ...
        with patch(
            ...
            assert isinstance(
                result, dict
            )  # Adjust this based on the actual return type
            ...
            for expected_name in expected_protocols:
                assert any(
                    product["name"] == expected_name for product in result["products"]
                )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                [
                    {"protocol": "zkLend", "products": []},  # Empty products list
                    {
                        "protocol": "zkLend",
                        "products": [
                            {
    ...
    def test_get_products_with_missing_products(
        self, dapps, expected_length, expected_tokens
    ):
        """
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                [
                    {"protocol": "validProtocol3", "products": []},
                    {"protocol": "validProtocol4", "products": []},
                ],
                0,
                [],
            ),
    ...
    def test_get_products_with_valid_dapps(
        self, dapps, expected_length, expected_tokens
    ):
        """
