...
const ResetPasswordForm = () => {
    ...
    const [passwordVisibleConfirm, setPasswordConfirmVisibility] = useState(false);
            ...
            <div className='flex flex-col'>
                ...
                <div className='w-100 relative flex items-center  justify-center'>
                    ...
                    <svg
                        ...
                        className="shrink-0 size-3.5 absolute right-4 cursor-pointer" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
