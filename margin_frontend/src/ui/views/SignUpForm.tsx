...
const PasswordVisibilityIcon = ({
  ...
  >
    ...
    <line className={isVisible ? 'hidden' : ''} x1='2' x2='22' y1='2' y2='22'></line>
    <path className={!isVisible ? 'hidden' : ''} d='M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7Z'></path>
    <circle className={!isVisible ? 'hidden' : ''} cx='12' cy='12' r='3'></circle>
  </svg>
);
