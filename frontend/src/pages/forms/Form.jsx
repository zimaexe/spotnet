...
const Form = () => {
  ...
  return (
    <div className="form-content-wrapper">
      ...
      {isClosePositionOpen && <ActionModal title="Open New Position" subTitle="Do you want to open new a position?" content={["You have already opened a position.", "Please close active position to open a new one.", "Click the ‘Close Active Position’ button to continue."]} cancelLabel='Cancel' submitLabel="Close Active Position" submitAction={onClosePositionAction} cancelAction={handleCloseModal}/>}
