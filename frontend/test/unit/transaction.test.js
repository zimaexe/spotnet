...
describe('Transaction Functions', () => {
    ...
    describe('sendTransaction', () => {
        ...
        it('should throw error if wallet is not connected', async () => {
            ...
            await expect(sendTransaction(validLoopLiquidityData, mockContractAddress))
                .rejects
        ...
        it('should throw error if loop_liquidity_data is invalid', async () => {
            ...
            await expect(sendTransaction(invalidData, mockContractAddress))
                .rejects
                .toThrow('Missing or invalid loop_liquidity_data fields');
        });
    ...
    describe('closePosition', () => {
        ...
        it('should handle close position errors', async () => {
            ...
            await expect(closePosition(mockTransactionData))
                .rejects
                .toThrow('Close position failed');
        });
    });
