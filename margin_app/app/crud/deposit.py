...
from app.crud.base import \
    DBConnector  # Import DBConnector for database operations
...
class DepositCRUD(DBConnector):
    ...
    async def create_deposit(self, user_id: uuid.UUID, token:str, amount: Decimal, transaction_id: str) -> Deposit:
        """
    ...
    async def update_deposit(self, deposit_id: uuid.UUID, update_data: Dict[str, Any]) -> Optional[Deposit]:
        """
